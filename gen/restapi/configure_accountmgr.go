...
//go:generate swagger generate server --target ..\..\gen --name Accountmgr --spec ..\..\swagger\swagger.yml --principal interface{} --exclude-main

func configureFlags(api *operations.AccountmgrAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.AccountmgrAPI) http.Handler {
	...
	if api.AccountAddAccountHandler == nil {
